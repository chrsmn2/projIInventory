...
<nav class="px-3 py-6 space-y-2 overflow-y-auto h-[calc(100vh-80px)]">
    ...
    <?php if($role === 'admin'): ?>
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>"
           class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium
                  <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-700' : ''); ?>">
        ...
        <!-- Master Data -->
        <div x-data="{ open: <?php echo e(request()->routeIs('admin.categories.*', 'admin.units.*', 'admin.items.*', 'admin.departement.*', 'admin.suppliers.*') ? 'true' : 'false'); ?> }">
            ...
            <div x-show="open" x-transition class="ml-4 mt-2 space-y-1.5 border-l border-gray-600 pl-3">
                <a href="<?php echo e(route('admin.categories.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-gray-700 text-white' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.units.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.units.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.items.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.items.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/>
                    </svg>
                    Items
                ...
                <a href="<?php echo e(route('admin.departement.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.departement.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.suppliers.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.suppliers.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- TRANSACTIONS -->
        <div x-data="{ open: <?php echo e(request()->routeIs('admin.incoming.*', 'admin.outgoing.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open"
                    class="w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium"
                    :class="{ 'bg-gray-700': open }">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-transition class="ml-4 mt-2 space-y-1.5 border-l border-gray-600 pl-3">
                <a href="<?php echo e(route('admin.incoming.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.incoming.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.outgoing.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.outgoing.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Report -->
        <div x-data="{ open: <?php echo e(request()->routeIs('admin.reports.*', 'admin.loans.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open"
                    class="w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium"
                    :class="{ 'bg-gray-700': open }">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-transition class="ml-4 mt-2 space-y-1.5 border-l border-gray-600 pl-3">
                ...
                <a href="<?php echo e(route('admin.reports.stock')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.reports.stock') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                    Stock Report
                </a>
                <a href="<?php echo e(route('admin.reports.movement')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.reports.movement') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Profile -->
        <div x-data="{ open: <?php echo e(request()->routeIs('admin.profile.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open"
                    class="w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium"
                    :class="{ 'bg-gray-700': open }">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-transition class="ml-4 mt-2 space-y-1.5 border-l border-gray-600 pl-3">
                <a href="<?php echo e(route('admin.profile.edit')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.profile.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <?php elseif($role === 'supervisor'): ?>
        ...
        <a href="<?php echo e(route('supervisor.dashboard')); ?>"
           class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium
                  <?php echo e(request()->routeIs('supervisor.dashboard') ? 'bg-gray-700' : ''); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-3m0 0l7-4 7 4M5 9v10a1 1 0 001 1h12a1 1 0 001-1V9m-9 16l4-4m-9-5l-2-3m0 0l-7-4 7-4"/>
            </svg>
        ...
        <!-- Approval -->
        <div x-data="{ open: <?php echo e(request()->routeIs('supervisor.loan-approvals.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open"
                    class="w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium"
                    :class="{ 'bg-gray-700': open }">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-transition class="ml-4 mt-2 space-y-1.5 border-l border-gray-600 pl-3">
                <a href="<?php echo e(route('supervisor.loan-approvals.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('supervisor.loan-approvals.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Monitoring -->
        <div x-data="{ open: <?php echo e(request()->routeIs('supervisor.stock.*', 'supervisor.loan.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open"
                    class="w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium"
                    :class="{ 'bg-gray-700': open }">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-transition class="ml-4 mt-2 space-y-1.5 border-l border-gray-600 pl-3">
                <a href="<?php echo e(route('supervisor.stock.index')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition
                          <?php echo e(request()->routeIs('supervisor.stock.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                    Stock Overview
                </a>
                <a href="<?php echo e(route('supervisor.stock.low')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('supervisor.loan.monitor')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
        ...
        <!-- Report -->
        <div x-data="{ open: <?php echo e(request()->routeIs('supervisor.reports.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open"
                    class="w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium"
                    :class="{ 'bg-gray-700': open }">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-transition class="ml-4 mt-2 space-y-1.5 border-l border-gray-600 pl-3">
                <a href="<?php echo e(route('supervisor.reports.loan')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                ...
                <a href="<?php echo e(route('supervisor.reports.stock')); ?>"
                   class="flex items-center gap-2 px-3 py-2 text-xs text-gray-300 rounded hover:bg-gray-700 hover:text-white transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
        ...
        <a href="<?php echo e(route('profile.edit')); ?>"
           class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-100 hover:bg-gray-700 transition font-medium
                  <?php echo e(request()->routeIs('profile.*') ? 'bg-gray-700' : ''); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Users\Mardiana Syafitry\projIInventory\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>