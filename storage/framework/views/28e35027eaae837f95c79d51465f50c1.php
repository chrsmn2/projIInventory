    ...
    <div class="flex-1 flex flex-col lg:ml-64">
        ...
        <header class="h-16 bg-gray-800 text-white border-b border-gray-700 flex items-center justify-between px-4 lg:px-6 shadow-md">
            ...
            <div class="flex items-center gap-3">
                <span class="hidden sm:inline text-sm"><?php echo e(auth()->user()->name ?? 'Admin'); ?></span>
                <?php if(auth()->user()->profile_photo): ?>
                    <img id="profile-photo-header" src="<?php echo e(asset('storage/' . auth()->user()->profile_photo)); ?>?<?php echo e(time()); ?>" 
                         alt="<?php echo e(auth()->user()->name); ?>" 
                         class="w-9 h-9 rounded-full object-cover border-2 border-gray-700 cursor-pointer hover:opacity-80 transition" 
                         onclick="window.location.href='<?php echo e(route('admin.profile.edit')); ?>'">
                <?php else: ?>
                    <div class="w-9 h-9 rounded-full bg-gray-600 flex items-center justify-center border-2 border-gray-700 cursor-pointer hover:bg-gray-500 transition" onclick="window.location.href='<?php echo e(route('admin.profile.edit')); ?>'">
...
<?php /**PATH C:\Users\Mardiana Syafitry\projIInventory\resources\views/layouts/admin.blade.php ENDPATH**/ ?>