...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div class="flex items-center">
            ...
            <div>
                <p class="text-sm font-medium text-gray-600">Outgoing</p>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.departement.index') }}" class="text-sm text-purple-600 hover:text-purple-700 font-medium">
                View →
            </a>
        </div>
    </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $totalVendors }}</p>
                </div>
            </div>
            <a href="{{ route('admin.suppliers.index') }}" class="text-sm text-teal-600 hover:text-teal-700 font-medium">
                View →
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <div class="bg-gray-50 p-3 rounded-lg mr-4">
            ...
            <a href="{{ route('admin.units.index') }}" class="text-sm text-gray-600 hover:text-gray-700 font-medium">
                View →
            </a>
        </div>
    </div>
