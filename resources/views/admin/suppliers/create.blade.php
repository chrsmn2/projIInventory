...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-xl border">
    ...
    <div class="px-6 py-4 bg-gradient-to-r from-gray-700 to-gray-800 rounded-t-xl">
        <h2 class="text-xl font-bold text-white">Add New Vendor</h2>
        <p class="text-sm text-gray-300">Create new supplier/vendor</p>
    </div>
    ...
    <form action="{{ route('admin.suppliers.store') }}"
        ...
        <div>
            ...
            <input type="text"
                   id="supplier_name"
                   name="supplier_name"
                   class="w-full mt-1 rounded-lg border @error('supplier_name') border-red-500 @else border-gray-300 @enderror
                          text-gray-900
            ...
            @enderror
            @include('admin.partials.check-name', ['type'=>'supplier', 'inputId'=>'supplier_name'])
        </div>
