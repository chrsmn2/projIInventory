...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-xl border">
    ...
    <div class="px-6 py-4 bg-gradient-to-r from-gray-700 to-gray-800 rounded-t-xl">
        <h2 class="text-xl font-bold text-white">Update Vendor</h2>
        <p class="text-sm text-gray-300">Update vendor details</p>
    </div>
    ...
    <form action="{{ route('admin.suppliers.update', $supplier->id) }}"
        ...
        <div>
            ...
            @include('admin.partials.check-name', [
                ...
                'original' => $supplier->supplier_name,
                'id' => $supplier->id
            ])
        </div>
        ...
        <div>
            ...
            <input type="text"
                   ...
                   class="w-full mt-1 rounded-lg border border-gray-300
                          text-gray-900
                          focus:ring-emerald-500 focus:border-emerald-500"
                   value="{{ old('phone', $supplier->contact_phone) }}">
