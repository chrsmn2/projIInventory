    ...
    <div class="flex items-center justify-between px-6 py-4 rounded-t-xl
        ...
        <div>
            ...
            <p class="text-sm text-gray-300">
                Detailed report of loan activities
            </p>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
            ...
            <form method="GET" class="flex items-center">
                ...
                <select name="status" onchange="this.form.submit()" class="px-3 py-2 border rounded-lg text-sm">
                ...
                <tr>
                    <td colspan="10" class="px-4 py-8 text-center text-gray-500">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-sm">Try adjusting your date range or status filter.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
