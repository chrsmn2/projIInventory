    ...
    <div class="flex items-center justify-between px-6 py-4 rounded-t-xl
        ...
        <div>
            ...
            <p class="text-sm text-gray-300">
                Inventory stock levels and analysis report
            </p>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
            ...
            <form method="GET" class="flex items-center">
                <select name="category" onchange="this.form.submit()" class="px-3 py-2 border rounded-lg text-sm">
            ...
            <form method="GET" class="flex items-center">
                ...
                <select name="condition" onchange="this.form.submit()" class="px-3 py-2 border rounded-lg text-sm">
                    <option value="">All Conditions</option>
                    <option value="good" {{ $condition == 'good' ? 'selected' : '' }}>Good</option>
                    <option value="damaged" {{ $condition == 'damaged' ? 'selected' : '' }}>Damaged</option>
                    <option value="maintenance" {{ $condition == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                </select>
            </form>
                ...
                <tr>
                    <td colspan="8" class="px-4 py-8 text-center text-gray-500">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-sm">Try adjusting your category or condition filter.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
