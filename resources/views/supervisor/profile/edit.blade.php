...
<div class="max-w-4xl mx-auto py-12">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-8">
        ...
        <div class="px-8 pb-8">
            ...
            <!-- Edit Profile Form -->
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6 border-t pt-8">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <textarea name="address" rows="3" 
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">{{ old('address', auth()->user()->address) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="bio" rows="3" placeholder="Ceritakan tentang Anda..."
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">{{ old('bio', auth()->user()->bio) }}</textarea>
                ...
                <div class="flex gap-4 pt-6">
                    ...
                    <a href="{{ route('supervisor.dashboard') }}" class="px-6 py-2 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition">
                        Batal
                    </a>
                </div>
            </form>
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
        ...
        <form action="{{ route('password.update') }}" method="POST" class="space-y-6 max-w-2xl">
            @csrf
            @method('PUT')
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-red-600">
        ...
        <form action="{{ route('profile.destroy') }}" method="POST" class="max-w-2xl" onsubmit="return confirm('Apakah Anda yakin ingin menghapus akun ini? Tindakan ini tidak dapat dibatalkan.');">
            @csrf
            @method('DELETE')
